...
<body class="font-poppins">
    <div
        ...
        <div class='md:flex md:justify-between py-4 px-10'>
            ...
            <ul id="navbar"
                ...
                <li class="hover:bg-slate-400 w-26 py-2 px-2 mx-2 rounded-full duration-500 cursor-pointer">Home</li>
                <li class="hover:bg-slate-400 w-26 py-2 px-2 mx-2 rounded-full duration-500 cursor-pointer">About</li>
                <li class="hover:bg-slate-400 w-26 py-2 px-2 mx-2 rounded-full duration-500 cursor-pointer">
                    <a href="#register">
                        Register
                    </a>
                </li>
    ...
    <div class="flex items-center justify-center h-screen bg-[#d1d5db]" id="register">
